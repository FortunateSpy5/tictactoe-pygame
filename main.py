...
o_img = pygame.transform.scale(o_img, (int(cell_size * 0.8), int(cell_size * 0.8)))

x_img = pygame.image.load('x.png')
x_img = pygame.transform.scale(x_img, (int(cell_size * 0.8), int(cell_size * 0.8)))
...
def draw():
  ...
  for i in range(3):
    for j in range(3):
      if board[i][j] == 1:
        screen.blit(x_img, ((i + 0.1) * cell_size, (j + 0.1) * cell_size))
      elif board[i][j] == 2:
        screen.blit(o_img, ((i + 0.1) * cell_size, (j + 0.1) * cell_size))
